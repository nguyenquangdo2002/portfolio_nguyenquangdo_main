...
const addToCart = document.querySelectorAll(".added-to-cart");
...
cartBtn.forEach((button) => {
  button.addEventListener("click", () => {
    ...
    if (matchingProduct) {
      matchingProduct.quantity += quantitySelector;
    } else {
      cart.push({
    ...
    document.querySelector(".js-cart-quantity").textContent = `${allQuantity}`;
